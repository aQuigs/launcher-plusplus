...
class WidgetPageStoreTest {
    ...
    fun thePickInProgressComesBackUntilItIsCleared() {
        store.savePick(WidgetPick(id = 14, pageRows = 9, columnWidthDp = 90, rowHeightDp = 84))
        assertEquals(WidgetPick(14, 9, 90, 84), SharedPreferencesWidgetPageStore(context).loadPick())
