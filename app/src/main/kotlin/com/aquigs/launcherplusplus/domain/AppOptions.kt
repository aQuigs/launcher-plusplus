...
fun appOptions(app: AppEntry, place: HomePlace?): List<AppOption> =
    listOfNotNull(place?.let(AppOption::Remove), AppOption.AppInfo, AppOption.Uninstall.takeIf { app.canUninstall })
